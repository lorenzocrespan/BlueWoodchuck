...
function ContractEntry(props) {
    ...
    return (
        <li>
            <article>
                <a rel="noopener noreferrer" className="grid p-4 overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 hover:dark:bg-gray-900" onClick={redirectPage}>
